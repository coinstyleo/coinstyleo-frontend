...
export const DEFAULT_META: PageMeta = {
  title: 'HCF Swap',
  description:
    'The most popular AMM on BSC by user count! Earn HCF through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by PancakeSwap), NFTs, and more, on a platform you can trust.',
  image: 'https://hcfswap.network/images/hero.png',
}
