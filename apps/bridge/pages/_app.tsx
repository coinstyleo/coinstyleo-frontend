  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Cheaper and faster than Uniswap? Discover HCFSwap, the leading DEX on BNB Smart Chain (BSC) with the best farms in DeFi and a lottery for CAKE."
        />
        <meta name="theme-color" content="#1FC7D4" />
        <meta name="twitter:image" content="https://hcfswap.network/images/hero.png" />
        <meta
        ...
        <meta name="twitter:title" content="🥞 HCFSwap - A next evolution DeFi exchange on BNB Smart Chain (BSC)" />
        <title>HCF Swap Bridge</title>
      </Head>
      <NextThemeProvider>
        <StyledThemeProvider>
          <ModalProvider>
